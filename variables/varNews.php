...
<ul class="nav nav-tabs " role="tablist" >
    <li class="nav-item ">
        <a class="nav-link active" data-toggle="tab" href="#news1" role="tab">Новости</a>
    </li>
    <li class="nav-item">
...
<div class="tab-content mb-2">
    <!-- Tab pane News -->
    <div class="tab-pane active   " id="news1" role="tabpanel">
    ...
    <!-- Tab pane skype -->
    <div class="tab-pane" id="skype" role="tabpanel">

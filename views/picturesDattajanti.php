...
<!--    <header class="text-center"><h3 >Даттаджаянти 3 декабря 2017</h3></header>-->
    <div class="jumbotron jumbotron jumbotron-background card-shadow">
        ...
        <p class="lead">
            День Явления Даттатрейи  прошёл 3 декабря . Наша Дхарма центр "Джняна Марга" праздновал Даттаджаянти  вместе со всеми Ашрамами и Дхарма центрами разрастающейся по всему миру  Сангхи. Силу Благословений и Радость медитаций и джапы (повторений имени Даттатрейи), невозможно передать словами. Когда все братья и сёстры собираются вместе и совершают определённые ритуальные действия вместе, медитируют и объединяют высокие вибрации, то божественная радость и чистота наполняет сердце каждого духовного искателя, каждого члена группы.
            Такие моменты объединяют и переносят нас в другое измерение - локу Света и Любви, Чистоты и Великолепия Божественной Радости.
            Спасибо всем огромное, кто принял участие в общем Празднике Даттаджаянти!
            Всех Благ!
            Намасте
